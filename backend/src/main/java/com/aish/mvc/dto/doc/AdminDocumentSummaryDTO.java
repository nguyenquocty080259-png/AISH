...
public class AdminDocumentSummaryDTO {
    ...
    private String aiScreenOutcome; // "PASS" | "FLAG" | null — kết quả AI của lần chờ duyệt hiện tại
    ...
    public AdminDocumentSummaryDTO(Long id, String title, String ownerName, String visibility,
        ...
        this(id, title, ownerName, visibility, moderationStatus, storageType, createdAt, null, null, null, null);
    }

    public AdminDocumentSummaryDTO(Long id, String title, String ownerName, String visibility,
                                   String moderationStatus, String storageType, LocalDateTime createdAt,
                                   String ingestStatus) {
        this(id, title, ownerName, visibility, moderationStatus, storageType, createdAt, ingestStatus, null, null, null);
    }
}
